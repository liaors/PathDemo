...
public class PathSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private void setCurAction(float x, float y) {
        switch (mActionType) {
            case Point:
                curAction = new MyPoint(x, y, paintColor);
                break;
            case Path:
                curAction = new MyPath(x, y, paintSize, paintColor);
                break;
            case Line:
                curAction = new MyLine(x, y, paintSize, paintColor);
                break;
            case Rect:
                curAction = new MyRect(x, y, paintSize, paintColor);
                break;
            case Circle:
                curAction = new MyCircle(x, y, paintSize, paintColor);
                break;
            case FillEcRect:
                curAction = new MyFillRect(x, y, paintSize, paintColor);
                break;
            case FilledCircle:
                curAction = new MyFillCircle(x, y, paintSize, paintColor);
                break;
            default:
                break;
        }
